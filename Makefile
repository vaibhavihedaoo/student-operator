...
# example.com/student-operator-bundle:$VERSION and example.com/student-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= example.com/student-operator
...
IMG ?= quay.io/vaibhavihedaoo/student-operator:latest
